...
3. The newest version becomes the canonical entry: title, username, password, URL, notes, icon, tags, expiry, OTP, colors, history — including its current group (so a moved entry lands where it was most recently).
